...
/* 
    ...
    Write a callback function belo(w that will
...
//  const filteredFood = foodArr.filter(foundTag((arr,searchTag)=>{filteredFood.push(arr[i]
//  )))

// function foundTag(arr,searchTag) {
// for (let i = 0; i<arr.length;i++){
//     for(let j = 0; j<arr[i].tags[j].length;j++)
//     if(arr[i].tags[j].includes(searchTag)){
//         return true;
//     }
//     return false;
// }
// }
// foundTag(foodArr, `gluten-free crust available` => 
//     }
//   })
...
//CODE HERE
foodArr.filter(filterByProperty);
...
//CODE HERE
filterByProperty('price', 20, 'above')